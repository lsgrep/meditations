...
I have always had a fond inclination towards meditation.
...
Primary function of human existince is self perservation. Bhagavad Gita and Stoic approaches tap into our default mode. 
We are temporarily phased in a safe space either by realization of our immortality or by the reconcialation with our death. 
It is as if we shut off the self perservation function, and use that extra power to focus on the task at hand. 
Or it magnifies the impending danger, such that we have to pull all the energy out to counter the risk. 
Either way, it is a powerful tool to have in your arsenal.
